...
import com.visualmix.api.doc.dto.ImpostoLojasDTO;
...
@Api(tags = "Imposto Loja", description = "Consulta de Imposto Loja")
@RequestMapping("/cadastro")
@RestController
public class ImpostoLojaController {

	@ApiOperation(value = "Obter Familias", notes = "Retorna todos as Imposto Loja")
