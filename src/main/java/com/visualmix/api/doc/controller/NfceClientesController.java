...
import com.visualmix.api.doc.dto.FamiliasDTO;
...
import com.visualmix.api.doc.dto.NfceClientesDTO;
...
public class NfceClientesController {
	...
	@ApiOperation(value = "Obter NfceClientes", notes = "Retorna todos os NfceClientes")
	@GetMapping("/nfceclientes")
	public PaginacaoDTO<NfceClientesDTO> get(
		...
		return new PaginacaoDTO<NfceClientesDTO>();
	}
