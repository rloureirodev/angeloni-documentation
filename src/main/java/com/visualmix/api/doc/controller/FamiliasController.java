...
@Api(tags = "Familias", description = "Consulta de Familias.")
@RequestMapping("/cadastro")
@RestController
public class FamiliasController {

	@ApiOperation(value = "Obter Familias", notes = "Retorna todos as Familias")
	@GetMapping("/familias")
	public PaginacaoDTO<FamiliasDTO> get(
		...
		return new PaginacaoDTO<FamiliasDTO>();
	}
