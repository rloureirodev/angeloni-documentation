...
import com.visualmix.api.doc.dto.OperadoresDTO;
...
@Api(tags = "Operadores", description = "Consulta de Operadores.")
@RequestMapping("/cadastro")
@RestController
public class OperadoresController {

	@ApiOperation(value = "Obter Operadores", notes = "Retorna todos os Operadores")
	@GetMapping("/operadores")
	public PaginacaoDTO<OperadoresDTO> get(
		...
		return new PaginacaoDTO<OperadoresDTO>();
	}
