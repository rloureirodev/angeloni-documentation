...
import com.visualmix.api.doc.dto.EmbalagemPrecoDTO;
...
@Api(tags = "Tabelas Preço", description = "Consulta de Tabelas Preço.")
@RequestMapping("/cadastro")
@RestController
public class TabelasPrecoController {

	@ApiOperation(value = "Obter Preços", notes = "Retorna todos as Tabelas Preço")
	@GetMapping("/tabelaspreco")
	public PaginacaoDTO<EmbalagemPrecoDTO> get(
		...
		return new PaginacaoDTO<EmbalagemPrecoDTO>();
	}
